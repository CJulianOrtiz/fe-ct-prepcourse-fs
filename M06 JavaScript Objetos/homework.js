...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var gatoNuevo = {nombre: nombre, edad: edad, meow: function () {
      var rta = "Meow!";
      return rta;
   }};
   return gatoNuevo;
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var usuarioNew = {nombre: nombre, email: email, password: password};
   return usuarioNew;
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   rta = (objetoMisterioso.numeroMisterioso *5);
   return rta;
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   rta = objeto.hasOwnProperty(propiedad);
   return rta;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.precioFinal = objetoProducto.calcularPrecioDescuento();
